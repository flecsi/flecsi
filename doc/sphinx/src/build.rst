...
* `Legion <https://legion.stanford.edu/>`_
...
* `Sphinx <https://www.sphinx-doc.org/>`_ : only required to build the web-based documentation.

* `Sphinx RTD Theme <https://sphinx-rtd-theme.readthedocs.io/>`_

* `Doxygen <https://www.doxygen.nl/>`_ : only required to build the interface documentation.
